...
namespace ZF\Doctrine\QueryBuilder\Filter\Hydrator\Strategy;
...
/**
 * A strategy for rendering embedded entities in HAL
 *
 * @returns Hal\Link
 */
    ...
    implements StrategyInterface, ServiceManagerAwareInterface
{
    ...
    public function extract($value)
    {
        ...
        if (!method_exists($value, 'getTypeClass') 
            or !isset($config['zf-hal']['metadata_map'][$value->getTypeClass()->name])) {
